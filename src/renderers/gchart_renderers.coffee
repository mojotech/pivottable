...
makeGoogleChart = (chartType, extraOptions) ->
  ...
  maxAggregators: extraOptions.maxAggregators
  render: (pivotData, opts) ->
    defaults =
      localeStrings:
        vs: "vs"
        by: "by"
...
$.pivotUtilities.gchart_renderers =
  "Line Chart": makeGoogleChart("LineChart", {maxAggregators: 1, name: 'Line Chart'})
  "Bar Chart": makeGoogleChart("ColumnChart", {maxAggregators: 1, name: 'Bar Chart'})
  "Stacked Bar Chart": makeGoogleChart("ColumnChart", {isStacked: true, maxAggregators: 1, name: 'Stacked Bar Chart'})
  "Area Chart": makeGoogleChart("AreaChart", {isStacked: true, maxAggregators: 1, name: 'Area Chart'})
