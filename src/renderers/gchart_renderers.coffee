...
makeGoogleChart = (chartType, extraOptions) ->
  numAggregators: extraOptions.numAggregators
...
$.pivotUtilities.gchart_renderers =
  "Line Chart": makeGoogleChart("LineChart", numAggregators: 1)
  "Bar Chart": makeGoogleChart("ColumnChart", numAggregators: 1)
  "Stacked Bar Chart": makeGoogleChart("ColumnChart", {isStacked: true, numAggregators: 1})
  "Area Chart": makeGoogleChart("AreaChart", {isStacked: true, numAggregators: 1})
